...
export default function ImmobilePreview({ immobile }: ImmobilePreviewProps) {
  const history = useHistory();

  function handleSeeImmobile(id: string) {
    history.push(`/SeeImmobile/${id}`)
  }
  return (
    <>
      <Flex w="700px" justify="space-between" h="230px" borderWidth="2px" borderColor="#00293A" >
        <VStack mx="auto" my="auto" mb="4" mt="2" spacing="4">
          ...
          <Flex >
            ...
            <Button textColor="white" bgColor="#00293A" mx="4">Contato</Button>
          </Flex>
